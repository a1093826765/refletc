...
public class MyReflect {
	...
	public void init() throws Exception {
		className = "com.bigdata.refletc.Person";
	 ...
	 * class.newInstance() --  jdk1.9被弃用
	 * class.getDeclaredConstructor().newInstance() --  取而代之
	 * 返回是toString()
	 */
	@Test
	...
	public void otherMethod() throws Exception {
		...
		System.out.println(Class.forName("com.bigdata.refletc.City").isEnum());
		
		//判断当前的Class对象表示是否是接口
		System.out.println(personClass.isInterface());
		System.out.println(Class.forName("com.bigdata.refletc.TestInterface").isInterface());
